...
import static com.github.xiesen.algorithm.xxhash.UnsafeAbstractAccess.BYTE_BASE;
import static java.nio.ByteOrder.LITTLE_ENDIAN;

/**
 * @author xiese
 * @Description Compress Latin1 Access
 * <p>
 * Explaination:
 * <p>
...
class CompactLatin1CharSequenceAbstractAccess extends AbstractAccess<byte[]> {
    @NotNull
    static final AbstractAccess<byte[]> INSTANCE = new CompactLatin1CharSequenceAbstractAccess();

    @NotNull
    private static final UnsafeAbstractAccess UNSAFE = UnsafeAbstractAccess.INSTANCE;
    ...
    private CompactLatin1CharSequenceAbstractAccess() {
    }
