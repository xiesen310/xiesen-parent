...
/**
 * @author xiese
 * @Description Tuple hash function producing more than 64-bit hash code into a result array of type
 * {@code long[]} from any byte sequences. See {@link AbstractLongHashFunction} for the definition of byte
 * sequence semantics and {@link ByteOrder} requirements for implementations.
 *
 * <p>Every {@link AbstractLongHashFunction} hash method has two corresponding ones in this class for different
 ...
 * {@link #hashVoid(long[])} and {@link #hash(Object, AbstractAccess, long, long, long[])} should be
 * implemented; other have default implementations which in the end delegate to
 * {@link #hash(Object, AbstractAccess, long, long, long[])} abstract method.
 *
 ...
 * {@link AbstractLongHashFunction} interface. And the length should also be a positive multiple of 8.
 *
 * <p>Also see {@link AbstractLongHashFunction} for additional information about subclassing andd access.
 * @Email xiesen310@163.com
 * @Date 2020/8/30 14:09
 * @see AbstractLongHashFunction LongHashFunction
 */
@ParametersAreNonnullByDefault
public abstract class AbstractLongTupleHashFunction implements Serializable {
     ...
     */
    @NotNull
    public static AbstractLongTupleHashFunction murmur3() {
     ...
     */
    @NotNull
    public static AbstractLongTupleHashFunction murmur3(final long seed) {
     ...
     */
    protected AbstractLongTupleHashFunction() {
    }
     ...
     * @throws IllegalArgumentException if {@code result.length < newResultArray().length}
     */
    public abstract <T> void hash(@Nullable T input, AbstractAccess<T> access,
                                  long off, long len, long[] result);

    /**
     * The result array is allocated on the fly, and no exceptions will be thrown.
     *
     * @see #hash(Object, AbstractAccess, long, long, long[])
     */
    @NotNull
    public <T> long[] hash(@Nullable final T input, final AbstractAccess<T> access,
     ...
     *
     * <p>Default implementation delegates to {@link #hash(Object, AbstractAccess, long, long, long[])}
     * method using {@linkplain AbstractAccess#unsafe() unsafe} {@code Access}.
     *
     * <p>The {@code result} array should be always created by {@link #newResultArray} method. When
     * storing, the {@code result[0 .. newResultArray().length-1]} will be accessed, the rest
     * elements of the array will not be touched when
     ...
     * {@link #hash(Object, AbstractAccess, long, long, long[])} using
     * {@link AbstractAccess#toNativeCharSequence()}, or to {@link #hashChars(char[], int, int, long[])}.
     *
     * <p>The {@code result} array should be always created by {@link #newResultArray} method. When
     * storing, the {@code result[0 .. newResultArray().length-1]} will be accessed, the rest
     * elements of the array will not be touched when
     ...
     *
     * <p>Default implementation delegates to {@link #hash(Object, AbstractAccess, long, long, long[])}
     * method using {@link AbstractAccess#toNativeCharSequence()}.
     *
     * <p>The {@code result} array should be always created by {@link #newResultArray} method. When
     * storing, the {@code result[0 .. newResultArray().length-1]} will be accessed, the rest
     * elements of the array will not be touched when
    ...
    @NotNull
    private static final AbstractAccess<Object> OBJECT_ACCESS = UnsafeAbstractAccess.INSTANCE;
    @NotNull
    private static final AbstractAccess<CharSequence> CHAR_SEQ_ACCESS = nativeCharSequenceAccess();
    @NotNull
    private static final AbstractAccess<ByteBuffer> BYTE_BUF_ACCESS = ByteBufferAbstractAccess.INSTANCE;

    private static void unsafeHash(final AbstractLongTupleHashFunction f, @Nullable final Object input,
                                   final long off, final long len, final long[] result) {
        f.hash(input, OBJECT_ACCESS, off, len, result);
    }

    private static void hashByteBuffer(final AbstractLongTupleHashFunction f, final ByteBuffer input,
                                       final int off, final int len, final long[] result) {
        if (input.hasArray()) {
    ...
    static void hashNativeChars(final AbstractLongTupleHashFunction f, final CharSequence input,
                                final int off, final int len, final long[] result) {
