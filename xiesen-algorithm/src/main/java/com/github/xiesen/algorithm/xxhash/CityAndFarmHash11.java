...
/**
 * @author xiese
 * @Description Adapted from the C++ CityHash implementation from Google at
 * https://github.com/google/cityhash/blob/8af9b8c2b889d80c22d6bc26ba0df1afb79a30db/src/city.cc.
 * @Email xiesen310@163.com
 * @Date 2020/8/30 14:25
 */
public class CityAndFarmHash11 {
    private static final long LONG_8 = 8L;
    private static final long LONG_4 = 4L;
    private static final long LONG_16 = 16L;
    private static final long LONG_32 = 32L;
    private static final long LONG_48 = 48L;
    private static final long LONG_64 = 64L;
    private static final long INT_64 = 64;

    private static final CityAndFarmHash11 INSTANCE = new CityAndFarmHash11();

    private static final CityAndFarmHash11 NATIVE_CITY = NATIVE_LITTLE_ENDIAN ?
            CityAndFarmHash11.INSTANCE : BigEndian.INSTANCE;
    ...
    <T> int fetch32(AbstractAccess<T> access, T in, long off) {
    ...
    private <T> long hashLen0To16(AbstractAccess<T> access, T in, long off, long len) {
        if (len >= LONG_8) {
            long a = fetch64(access, in, off);
            long b = fetch64(access, in, off + len - LONG_8);
            return hash8To16Bytes(len, a, b);
        } else if (len >= LONG_4) {
            long a = Primitives.unsignedInt(fetch32(access, in, off));
            long b = Primitives.unsignedInt(fetch32(access, in, off + len - LONG_4));
    ...
    private <T> long hashLen17To32(AbstractAccess<T> access, T in, long off, long len) {
        long mul = mul(len);
        long a = fetch64(access, in, off) * K1;
        long b = fetch64(access, in, off + LONG_8);
        long c = fetch64(access, in, off + len - LONG_8) * mul;
        long d = fetch64(access, in, off + len - LONG_16) * K2;
        return hashLen16(rotateRight(a + b, 43) + rotateRight(c, 30) + d,
                a + rotateRight(b + K2, 18) + c, mul);
    }

    private <T> long cityHashLen33To64(AbstractAccess<T> access, T in, long off, long len) {
        long mul = mul(len);
        ...
        long g = fetch64(access, in, off + len - LONG_8);
    ...
    <T> long cityHash64(AbstractAccess<T> access, T in, long off, long len) {
        if (len <= 32L) {
            if (len <= 16L) {
    ...
    private static class BigEndian extends CityAndFarmHash11 {
    ...
    private static class AsAbstractLongHashFunction extends AbstractLongHashFunction {
        ...
        public <T> long hash(T input, AbstractAccess<T> access, long off, long len) {
            ...
            if (access.byteOrder(input) == LITTLE_ENDIAN) {
                hash = CityAndFarmHash11.INSTANCE.cityHash64(access, input, off, len);
            } else {
    ...
    private static class AsAbstractLongHashFunctionSeeded extends AsAbstractLongHashFunction {
        ...
        private AsAbstractLongHashFunctionSeeded(long seed0, long seed1) {
            this.seed0 = seed0;
            this.seed1 = seed1;
    ...
    static AbstractLongHashFunction asLongHashFunctionWithSeed(long seed) {
        return new AsAbstractLongHashFunctionSeeded(K2, seed);
    }

    static AbstractLongHashFunction asLongHashFunctionWithTwoSeeds(long seed0, long seed1) {
        return new AsAbstractLongHashFunctionSeeded(seed0, seed1);
    }


    // FarmHash

    private <T> long naHashLen33To64(AbstractAccess<T> access, T in, long off, long len) {
        long mul = mul(len);
        long a = fetch64(access, in, off) * K2;
    ...
    <T> long naHash64(AbstractAccess<T> access, T in, long off, long len) {
        final long seed = 81;
        if (len <= 32) {
            if (len <= 16) {
                return hashLen0To16(access, in, off, len);
    ...
    private <T> long naHash64WithSeeds(AbstractAccess<T> access, T in, long off, long len, long seed0, long seed1) {
    ...
    <T> long uoHash64WithSeeds(AbstractAccess<T> access, T in, long off, long len, long seed0, long seed1) {
        if (len <= 64) {
    ...
    private static class Na extends AsAbstractLongHashFunction {
        private static final long serialVersionUID = 0L;
        ...
        public <T> long hash(T input, AbstractAccess<T> access, long off, long len) {
            long hash;
            if (access.byteOrder(input) == LITTLE_ENDIAN) {
                hash = CityAndFarmHash11.INSTANCE.naHash64(access, input, off, len);
            } else {
    ...
    static AbstractLongHashFunction naWithoutSeeds() {
    ...
    static AbstractLongHashFunction naWithSeed(long seed) {
        return new NaSeeded(K2, seed);
    }

    static AbstractLongHashFunction naWithSeeds(long seed0, long seed1) {
        return new NaSeeded(seed0, seed1);
    }

    private static final class Uo extends AsAbstractLongHashFunction {
        private static final long serialVersionUID = 0L;
        ...
        @Override
        public <T> long hash(T input, AbstractAccess<T> access, long off, long len) {
            CityAndFarmHash11 instance = access.byteOrder(input) == LITTLE_ENDIAN ?
                    CityAndFarmHash11.INSTANCE : BigEndian.INSTANCE;
            if (len <= INT_64) {
    ...
    static AbstractLongHashFunction uoWithoutSeeds() {
        return Uo.SEEDLESS_UO;
    }

    private final static class UoWithOneSeed extends AsAbstractLongHashFunctionSeeded {
        private static final long serialVersionUID = 0L;
    ...
    static AbstractLongHashFunction uoWithSeed(long seed) {
        return new UoWithOneSeed(seed);
    }

    private static class UoSeeded extends AsAbstractLongHashFunctionSeeded {
        private static final long serialVersionUID = 0L;
        ...
        public <T> long hash(T input, AbstractAccess<T> access, long off, long len) {
            if (access.byteOrder(input) == LITTLE_ENDIAN) {
                return CityAndFarmHash11.INSTANCE.uoHash64WithSeeds(
    ...
    static AbstractLongHashFunction uoWithSeeds(long seed0, long seed1) {
