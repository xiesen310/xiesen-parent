...
import static com.github.xiesen.algorithm.xxhash.AbstractCharSequenceAccess.nativeCharSequenceAccess;
import static com.github.xiesen.algorithm.xxhash.UnsafeAbstractAccess.*;
import static com.github.xiesen.algorithm.xxhash.Util.VALID_STRING_HASH;
import static com.github.xiesen.algorithm.xxhash.Util.checkArrayOffs;

/**
 * @author xiese
 * @Description Hash function producing {@code long}-valued result from byte sequences of any length and
 ...
 *     <li>For {@link #hash(Object, AbstractAccess, long, long)} method byte sequence abstraction
 *     is defined by the given {@link AbstractAccess} strategy to the given object.</li>
 * </ul>
 *
 ...
 * that accept single primitives, {@link #hashVoid()} and {@link #hash(Object, AbstractAccess, long, long)}
 * should be implemented; other have default implementations which in the end delegate to
 * {@link #hash(Object, AbstractAccess, long, long)} abstract method.
 *
 ...
 * @Date 2020/8/30 14:04
 */
public abstract class AbstractLongHashFunction implements Serializable {
     ...
     *
     * @see #city11(long)
     * @see #city11(long, long)
     */
    public static AbstractLongHashFunction city11() {
        return CityAndFarmHash11.asLongHashFunctionWithoutSeed();
    }
     ...
     * @see #city11(long, long)
     */
    public static AbstractLongHashFunction city11(long seed) {
        return CityAndFarmHash11.asLongHashFunctionWithSeed(seed);
    }
     ...
     * @see #city11(long)
     */
    public static AbstractLongHashFunction city11(long seed0, long seed1) {
        return CityAndFarmHash11.asLongHashFunctionWithTwoSeeds(seed0, seed1);
    }
     ...
     * output is equivalent to {@link #city11()} output.
     *
     * @see #farmNa(long)
     * @see #farmNa(long, long)
     */
    public static AbstractLongHashFunction farmNa() {
        return CityAndFarmHash11.naWithoutSeeds();
    }
     ...
     *
     * <p>{@code farmhashna} was introduced in FarmHash 1.0. For inputs shorter than 32 bytes it's
     * output is equivalent to {@link #city11(long)} output.
     *
     * @see #farmNa()
     * @see #farmNa(long, long)
     */
    public static AbstractLongHashFunction farmNa(long seed) {
        return CityAndFarmHash11.naWithSeed(seed);
    }
     ...
     *
     * <p>{@code farmhashna} was introduced in FarmHash 1.0. For inputs shorter than 32 bytes it's
     * output is equivalent to {@link #city11(long, long)} output.
     *
     * @see #farmNa()
     * @see #farmNa(long)
     */
    public static AbstractLongHashFunction farmNa(long seed0, long seed1) {
        return CityAndFarmHash11.naWithSeeds(seed0, seed1);
    }
     ...
     */
    public static AbstractLongHashFunction farmUo() {
        return CityAndFarmHash11.uoWithoutSeeds();
    }
     ...
     * @see #farmUo(long, long)
     */
    public static AbstractLongHashFunction farmUo(long seed) {
        return CityAndFarmHash11.uoWithSeed(seed);
    }
     ...
     * @see #farmUo(long)
     */
    public static AbstractLongHashFunction farmUo(long seed0, long seed1) {
        return CityAndFarmHash11.uoWithSeeds(seed0, seed1);
    }
     ...
     * @see #murmur3(long)
     */
    public static AbstractLongHashFunction murmur3() {
     ...
     * @see #murmur3()
     */
    public static AbstractLongHashFunction murmur3(long seed) {
     ...
     * @see #xx(long)
     */
    public static AbstractLongHashFunction xx() {
     ...
     * @see #xx()
     */
    public static AbstractLongHashFunction xx(long seed) {
     ...
     * @see #wy3(long)
     */
    public static AbstractLongHashFunction wy3() {
     ...
     * @see #wy3()
     */
    public static AbstractLongHashFunction wy3(long seed) {
     ...
     * @see #metro(long)
     */
    public static AbstractLongHashFunction metro() {
     ...
     * @see #metro()
     */
    public static AbstractLongHashFunction metro(long seed) {
     ...
     */
    protected AbstractLongHashFunction() {
    }
     ...
     */
    public abstract <T> long hash(T input, AbstractAccess<T> access, long off, long len);

    private long unsafeHash(Object input, long off, long len) {
        return hash(input, UnsafeAbstractAccess.INSTANCE, off, len);
    }
     ...
     *
     * <p>Default implementation delegates to {@link #hash(Object, AbstractAccess, long, long)} method
     * using {@linkplain AbstractAccess#unsafe() unsafe} {@code Access}.
     *
     ...
     *
     * <p>Default implementation delegates to {@link #hash(Object, AbstractAccess, long, long)} method
     * using {@link AbstractAccess#toByteBuffer()}.
     *
    ...
    private long hashByteBuffer(@NotNull ByteBuffer input, int off, int len) {
        if (input.hasArray()) {
            ...
            return hash(input, ByteBufferAbstractAccess.INSTANCE, off, len);
        }
    }
     ...
     *
     * <p>Default implementation could either delegate to {@link #hash(Object, AbstractAccess, long, long)}
     * using {@link AbstractAccess#toNativeCharSequence()}, or to {@link #hashChars(char[], int, int)}.
     *
