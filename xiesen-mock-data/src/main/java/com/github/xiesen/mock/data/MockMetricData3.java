 ...
 */
public class MockMetricData3 {
    private static String topic = "test";
//    private static String brokerAddr = "192.168.70.6:9092,192.168.70.7:9092,192.168.70.8:9092";
    private static String brokerAddr = "zork80-22.host.com:9092,zork80-23.host.com:9092,zork80-24.host.com:9092";
...
//            "mock_cpu_system_mb",
    ...
    public static void mockJsonWithIAndMetricSetName(long startTime, long endTime, String ipPrefix, String metricSetName) throws ExecutionException, InterruptedException {
        ...
        while (i < endTime) {
            //String metricSetName = randomMetricSetName();
            // appsystem,ip,hostname,metricname|value|
            String timestamp = String.valueOf(i);
            Map<String, Object> dimensions = new HashMap<>();
//            dimensions.put("appsystem", "dev_test");
            dimensions.put("appsystem", "开发测试环境");
            dimensions.put("hostname", "zorkdata70-" + ipPrefix + ".host.com");
            dimensions.put("ip", "192.168.70." + ipPrefix);
            dimensions.put("metricname", metricSetName);
            dimensions.put("metricname2", metricSetName);

            Map<String, Object> metrics = new HashMap<>();

            metrics.put("value", randomUserPct());
            metrics.put("value2", randomUserPct());
//            metrics.put("value", "abc");
...
//            map.put("metricsetname", metricSetName);
    ...
    public static void buildMessage() throws ExecutionException, InterruptedException {
        String metricSetName = "cpu_cloud1";
