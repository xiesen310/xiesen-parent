 ...
 */
public class MockFlinkSqlJsonData2 {
...
//        String topic = "test";
    ...
    private static String mockJson() {
        ...
        jsonObject.put("message", utcTimeStr + " INFO org.apache.hadoop.yarn.server.nodemanager.recovery.NMLeveldbStateStoreService: Full compaction cycle completed in 1 msec. " + UUID.randomUUID());
        JSONObject metadata = new JSONObject();
        metadata.put("service_name", "app");
        metadata.put("host_ip", "192.168.1.1");
        metadata.put("status", "waring");
