 ...
 * 模拟君弘指标 avro 数据
 */
public class MockSpecialCharacterMetricAvro {
    /**
     * 集中交易系统: jzjy*
     * 君弘: JHSystem*
     */
...
//        int i = random.nextInt(10);
        ...
        dimensions.put("specialCharacter", "a:b@c$aa.xx+dd^cc[test]ddd(abc)|{xyz},海清，,@#$%^&*()!!`?./");
//        dimensions.put("specialCharacter", "\\,\\@\\#\\$\\%\\^\\&\\*\\(\\)\\!\\!\\`\\?./ a:b@c$aa.xx+dd^cc[test]ddd(abc)|{xyz},海清，,@#$%^&*()!!`?./");
        return dimensions;
    }
...
//        metrics.put("user_pct", getRandomDouble());
        metrics.put("user_pct", 0.3);
        return metrics;
    }
...
//    public static final List<String> METRIC_SET_NAMES = Arrays.asList("cpu", "cpu_system_mb", "memory_system_mb", "filesystem", "process_num");
    public static final List<String> METRIC_SET_NAMES = Arrays.asList("cpu", "cpu_system_mb");
