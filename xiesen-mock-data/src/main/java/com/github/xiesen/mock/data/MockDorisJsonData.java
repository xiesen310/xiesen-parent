 ...
 */
public class MockDorisJsonData {
     ...
     *
     * @return ts, host, path, message
     */
    public static String buildMsg() {
        JSONObject bigJson = new JSONObject();
        bigJson.put("ts", new DateTime().toString());
        bigJson.put("host", "192.168.1.1");
        bigJson.put("path", "/var/logs/message");
        bigJson.put("message", "test-cluster");
    ...
    public static void main(String[] args) throws InterruptedException {
        String topic = "log__topic";
        String bootstrapServers = "192.168.70.6:9092";
        long records = 1000L;
