 ...
 */
public class MockDevParseLogData {
    ...
    public static String buildMsg() {
        ...
        bigJson.put("servicecode", "kafka");
        bigJson.put("appprogramname", "kafka");
    ...
    public static void main(String[] args) throws InterruptedException {
        String topic = "xiesen_ods_default_log";
