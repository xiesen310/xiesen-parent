create table streamx_metric_cpu (
    ...
    type = 'kafka11',
    zookeeperQuorum = 'zorkdata-91:2181',
    kafka.key.deserializer = 'org.apache.kafka.common.serialization.StringDeserializer',
    sourceDataType = 'metricavro',
    kafka.value.deserializer = 'org.apache.kafka.common.serialization.ByteArrayDeserializer',
    bootstrapServers = 'zorkdata-91:9092',
    groupId = 'streamx_sql_01',
    parallelism = '1',
    topic = 'metric2metric',
    schemaString = 'appsystem,appprogramname,hostname,ip|cpu_usage_rate|',
    offsetReset = 'earliest'
);

create table streamx_metric_cpu_1m (
    timestamp TIMESTAMP, appprogramname varchar,
    appsystem varchar, hostname varchar, ip varchar,
    cpu_usage_1m double
) with (
    type = 'kafka11',
    zookeeperQuorum = 'zorkdata-91:2181',
