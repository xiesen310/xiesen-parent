package com.github.xiesen.sqlserver.utils;
...
public class SqlServerJdbcUtils {
    ...
    static {
        ...
        try {
            dataSource.configFromPropety(prop); /** 加载配置 */
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static SqlServerJdbcUtils instance = null;

    public static SqlServerJdbcUtils getInstance() {

        if (instance == null) {
            synchronized (SqlServerJdbcUtils.class) {
                if (instance == null) {
                    instance = new SqlServerJdbcUtils();
                }
            }
        }
